...
u16_t ADC_Handler(int iIndex, char *pcInsert, int iInsertLen)
{
  ...
  {  
    char Digit1=0, Digit2=0, Digit3=0, Digit4=0; 
     ...
     Digit2= 1/100;
     Digit3= (1)/10;
     Digit4= 15 -((Digit1*1000)+(Digit2*100)+ (Digit3*10));    
//     Digit1= avgADVal/1000;
//     Digit2= (avgADVal-(Digit1*1000))/100;
//     Digit3= (avgADVal-((Digit1*1000)+(Digit2*100)))/10;
//     Digit4= avgADVal -((Digit1*1000)+(Digit2*100)+ (Digit3*10));
