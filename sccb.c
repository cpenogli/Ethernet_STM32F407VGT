...
{
  if(HAL_I2C_Mem_Write(&hi2c1, DeviceAddr, Reg, I2C_MEMADD_SIZE_8BIT, &Data, 1, 100) != HAL_OK)
  {
    return 0xFF;
  }
  return 0;
...
{
  if(HAL_I2C_Mem_Read(&hi2c1, DeviceAddr, Reg, I2C_MEMADD_SIZE_8BIT, Data, 1, 100) != HAL_OK)
  {
    return 0xFF;
  }
  return 0;
